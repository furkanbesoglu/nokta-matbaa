<%@ Page Title="" Language="C#" MasterPageFile="~/Ana.Master" AutoEventWireup="true" CodeBehind="Butiqline.aspx.cs" Inherits="nokta_matbaa.User.Butiqline" %>
     ...
     <div class="banner-area banner-bg-1">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="banner">
                        <h2><span>BUTIQLİNE</span></h2>
                        <ul class="page-title-link">
                            <li><a href="#">Ansayfa</a></li>
                            <li><a href="#">BUTIQLİNE</a></li>
                        </ul>
                    </div>
                </div>
            </div>
