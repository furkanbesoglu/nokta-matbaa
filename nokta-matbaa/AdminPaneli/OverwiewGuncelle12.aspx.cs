...
{
    public partial class OverwiewGuncelle : System.Web.UI.Page
    {
        int id;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable sonuc = methodlar.gosterDataTablosu("Connnokta_matbaa", "sp_Overview1", parametreAdi, parametreDeğeri);
            if (IsPostBack == false)
            {
        ...
        protected void btnGüncelle_Click(object sender, EventArgs e)
        {
            if (Kontroller()=="")
            {
                ...
                string sonuc = methodlar.EkleGuncelleSil("Connnokta_matbaa", "sp_Overview1", parametreAdi, parametreDeğeri);
                Response.Redirect("Overwiev.aspx");
            }
            else
            {
