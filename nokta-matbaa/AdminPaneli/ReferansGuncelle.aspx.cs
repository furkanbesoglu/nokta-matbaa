...
{
    public partial class ReferansGuncelle : System.Web.UI.Page
    {
        int id;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            object[] parametreDeğeri = new object[] { "SELECT", id };
            DataTable sonuc = methodlar.gosterDataTablosu("Connnokta_matbaa", "sp_Referans", parametreAdi, parametreDeğeri);
            if (IsPostBack == false)
            {
                imgPicture.ImageUrl = sonuc.Rows[0]["ReferansPhotoURL"].ToString();
        ...
        {
            string[] parametreAdi = new string[] { "@Event", "@ReferansID", "@ReferansPhotoURL" };
            object[] parametreDeğeri = new object[] { "UPDATE", id, imgPicture.ImageUrl };
