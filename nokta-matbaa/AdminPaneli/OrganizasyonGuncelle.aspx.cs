...
{
    public partial class OrganizasyonGuncelle : System.Web.UI.Page
    {
        int id;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable sonuc = methodlar.gosterDataTablosu("Connnokta_matbaa", "sp_organizasyon", parametreAdi, parametreDeğeri);
            if (IsPostBack == false)
            {
        ...
        protected void btnguncelle_Click(object sender, EventArgs e)
        {
            if (Kontroller() == "")
            {
                ...
                string sonuc = methodlar.EkleGuncelleSil("Connnokta_matbaa", "sp_organizasyon", parametreAdi, parametreDeğeri);
                Response.Redirect("OrganizasyonList.aspx");
            }
            else
            {
        ...
        string Kontroller()
        {
            ...
            {
                mesaj += "0 İLA 30 KARAKTER ARASINDA GİREBELİRİSNİZ";
            }
            if (!(textareaIcerik.Value.Length > 0 && textareaIcerik.Value.Length < 1400))
            {
                mesaj += "0 İLA 1400 KARAKTER ARASINDA GİREBELİRİSNİZ";
            }
