...
{
    public partial class OrganizasyonNEW : System.Web.UI.Page
    {
        ...
        protected void btnNEW_Click(object sender, EventArgs e)
        {
            if (Kontroller()=="")
            {
                ...
                string sonucYazisi = methodlar.EkleGuncelleSil("Connnokta_matbaa", "sp_organizasyon", parametreAdi, parametreDegeri);
