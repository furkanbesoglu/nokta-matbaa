...
{
    public partial class WebSiteGuncelle : System.Web.UI.Page
    {
        int id;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable sonuc = methodlar.gosterDataTablosu("Connnokta_matbaa", "sp_website", parametreAdi, parametreDeğeri);
            if (IsPostBack == false)
            {
        ...
        protected void btnguncelle_Click(object sender, EventArgs e)
        {
            ...
            string sonuc = methodlar.EkleGuncelleSil("Connnokta_matbaa", "sp_website", parametreAdi, parametreDeğeri);
