...
{
    public partial class ServicesEkle : System.Web.UI.Page
    {
        ...
        protected void btnNEW_Click(object sender, EventArgs e)
        {
            if (Kontroller() == "")
            {
                ...
                string sonucYazisi = methodlar.EkleGuncelleSil("Connnokta_matbaa", "sp_Services", parametreAdi, parametreDegeri);
        ...
        string Kontroller()
        {
            ...
            {
                mesaj += "0 İLA 1400 ARASINDA KARAKTER GİREBİLİRSİNİZ";
            }
