...
{
    public partial class ServicesGuncelle : System.Web.UI.Page
    {
        int id;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable sonuc = methodlar.gosterDataTablosu("Connnokta_matbaa", "sp_Services", parametreAdi, parametreDeğeri);
            if (IsPostBack == false)
            {
        ...
        protected void btnguncelle_Click(object sender, EventArgs e)
        {
            if (Kontroller() == "")
            {
                ...
                string sonuc = methodlar.EkleGuncelleSil("Connnokta_matbaa", "sp_Services", parametreAdi, parametreDeğeri);
        ...
        string Kontroller()
        {
            ...
            if (!(txtBaslik.Text.Length >= 0 && txtBaslik.Text.Length <= 20))
            {
                mesaj += "0 İLA 20 ARASINDA KARAKTER GİREBİLİRSİNİZ";
            }
            if (!(textareaIcerik.Value.Length >= 0 && textareaIcerik.Value.Length <= 300))
            {
                mesaj += "0 İLA 300 ARASINDA KARAKTER GİRİNİZ";
            }
