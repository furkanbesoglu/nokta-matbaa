<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPaneli/ana.Master" AutoEventWireup="true" CodeBehind="AdvertisingAgencyGuncelle.aspx.cs" Inherits="nokta_matbaa.AdminPaneli.AdvertisingAgencyGuncelle" %>
       ...
       <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="box">
                    <div class="info">
                        <h5 class="text-center">Alt Başlık</h5>
                        <div class="col-md-12">
